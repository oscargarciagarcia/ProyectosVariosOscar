package com.example.tartanuk.descargarweb;

/**
 * Created by tartanuk on 4/2/16.
 */
...
public class DescargarPagina extends AsyncTask<String, String, String> {

    private TextView dataField;
    private Context context;


    public DescargarPagina(Context context,TextView dataField) {
