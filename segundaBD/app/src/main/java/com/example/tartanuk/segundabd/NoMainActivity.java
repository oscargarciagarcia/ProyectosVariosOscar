...
/**
 * Created by tartanuk on 11/1/16.
 */
public class NoMainActivity extends SQLiteOpenHelper {
    ...
    public NoMainActivity(Context contexto, String nombre, CursorFactory almacen, int version){
